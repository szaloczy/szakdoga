...
export const hu: NestedI18n = {
    ...
    dashboard: {
        ...
        student: {
            ...
            hour_logging: {
                title: { text: "Munkaórák rögzítése" },
                date: { text: "Dátum" },
                date_required: { text: "A dátum megadása kötelező" },
                start_time: { text: "Kezdés ideje" },
                start_time_required: { text: "A kezdés idejének megadása kötelező" },
                end_time: { text: "Befejezés ideje" },
                end_time_required: { text: "A befejezés idejének megadása kötelező" },
                duration: { text: "Időtartam" },
                description: { text: "Leírás" },
                description_required: { text: "A leírás megadása kötelező" },
                description_min_length: { text: "A leírásnak legalább 10 karakter hosszúnak kell lennie" },
                description_placeholder: { text: "Írja le, min dolgozott ebben az időszakban..." },
                description_help: { text: "Kérjük, adjon meg részletes leírást a munkavégzésről" },
                cancel: { text: "Mégse" },
                submit: { text: "Órák rögzítése" },
                success: { text: "Órák sikeresen rögzítve!" },
                error: { text: "Hiba az órák rögzítése során. Kérjük, próbálja újra." },
                error_invalid_time: { text: "A befejezés időpontjának a kezdés időpontja után kell lennie" }
            },
            my_hours: {
                title: { text: "Munkaóráim" },
                all: { text: "Összes" },
                approved: { text: "Jóváhagyott" },
                pending: { text: "Függőben" },
                rejected: { text: "Elutasított" },
                no_hours: { text: "Még nincsenek rögzített órák" },
                date: { text: "Dátum" },
                time: { text: "Időpont" },
                duration: { text: "Időtartam" },
                description: { text: "Leírás" },
                status: { text: "Státusz" },
                status_approved: { text: "Jóváhagyva" },
                status_pending: { text: "Függőben" },
                status_rejected: { text: "Elutasítva" },
                total: { text: "Összesen" },
                close: { text: "Bezárás" }
            }
        },
