    ...
    dashboard: {
        ...
        student: {
            ...
            hour_logging: {
                ...
                date: { text: "Date" },
                date_required: { text: "Date is required" },
                start_time: { text: "Start Time" },
                start_time_required: { text: "Start time is required" },
                end_time: { text: "End Time" },
                end_time_required: { text: "End time is required" },
                duration: { text: "Duration" },
                description: { text: "Description" },
                description_required: { text: "Description is required" },
                description_min_length: { text: "Description must be at least 10 characters" },
                description_placeholder: { text: "Describe your work activities for this period..." },
                description_help: { text: "Please provide a detailed description of what you worked on" },
                cancel: { text: "Cancel" },
                submit: { text: "Log Hours" },
                success: { text: "Hours logged successfully!" },
                error: { text: "Error logging hours. Please try again." },
                error_invalid_time: { text: "End time must be after start time" }
            },
            my_hours: {
                title: { text: "My Work Hours" },
                all: { text: "All" },
                approved: { text: "Approved" },
                pending: { text: "Pending" },
                rejected: { text: "Rejected" },
                no_hours: { text: "No hours logged yet" },
                date: { text: "Date" },
                time: { text: "Time" },
                duration: { text: "Duration" },
                description: { text: "Description" },
